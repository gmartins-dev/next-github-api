...
export default function LinksArea({ links }: LinksAreaPropos) {
  ...
  return (
    <C.Container>
      <C.Link className={`${!links.location && "unavailable"}`}>
        ...
        <C.Data>{links.location || "Not Available"}</C.Data>
      </C.Link>

      <C.Link className={`${!links.blog && "unavailable"}`}>
        {links.blog ? (
          <a href={links.blog}>
          ...
          <>
            ...
            <C.Data>Not Available</C.Data>
          </>
        )}
      </C.Link>
      <C.Link className={`${!links.twitter && "unavailable"}`}>
        {links.twitter ? (
      ...
      <C.Link className={`${!links.company && "unavailable"}`}>
        <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
          <g fill={lightMode ? "#4b6a9b" : "#fff"}>
        ...
        <C.Data>{links.company || "Not Available"}</C.Data>
      </C.Link>
    </C.Container>
  );
}
